...
var promoBox = function (o) {
  ...
  PB = {
    addStyles: function () {
      ...
      var styles = [
        ...
        "#promoImage { height: auto; width: auto; max-width: 100%; max-height: 75%; box-sizing: border-box; display: block; }",
        "#promoClose {position: absolute;top: 0;right: 0;display: block;line-height: 16px;text-align: right;padding: 7px 10px;color: #fff;background-color: red;font-family: sans-serif;font-size: 17px;opacity: 0.6;transition: 0.1s all;text-decoration: none;}",
    ...
    buildPromo: function () {
      ...
      this.promo = {
        ...
        close: PBlib.makeElement("a", { id: "promoClose", href: "#" }, o.closeButtonText || "X"),
      ...
      if (o.interstitialDuration) {
        ...
        this.promo.interstitialSkipText = PBlib.makeElement("a", { id: "interstitialSkipText", href: "#" }, o.interstitialSkipText);
      ...
      if (o.actionButtons && o.actionButtons.length) {
        for (i = 0; i < o.actionButtons.length; i = i + 1) {
          this.promo.buttons.appendChild(PBlib.makeElement("a", { href: o.actionButtons[i][1] || "#promoClose", target: o.actionButtons[i][2] || "", class: o.actionButtons[i][3] || "" }, o.actionButtons[i][0]));
        }
  ...
  if (PB.init()) {
    PBlib.loadSprite(o.imagePath, function () {
      window.promoBoxInstanceID =
        clearTimeout(window.promoBoxInstanceID) ||
        setTimeout(function () {
          PB.startPromo();
        }, o.loadDelay * 1000);
    });
...
promoBox({ imagePath: demoImage, fadeInDuration: 0.33, fadeOutDuration: 0.2 });
