            ...
            <div class="container" style=" padding:0px !important;">
                ...
                <div class="col-12 tabmenu">
                    ...
                    <form action="" method="POST" class="hidden-mobile">
                            ...
                            <div class="row game">
                                <?php foreach ($game['games'] as $loop): ?>
                                    <?php if ($loop['status'] == 'On'): ?>
                                        <div class="col-sm-4 col-lg-3 col-4 text-center" style="display: grid;">
                                            <div class="card mb-4 phy-card">
