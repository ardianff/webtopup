...
<body>
        ...
        <footer id="aboutus" class="bg-footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-sm-3">
                                ...
                                <a href="<?= $sm['tw']; ?>" style="font-size: 35px;">
                                    <img src="<?= base_url(); ?>/assets/images/tik-tok.png">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="fab-container">
                <div class="fab fab-icon-holder" style="background-color:#FFF; padding:5px">
                    <img src="<?= base_url(); ?>/assets/images/callcenter.webp" class="img-fluid2" alt="hehe">
                </div>
    ...
    <script src="<?= base_url(); ?>/assets/js/promobox.js"></script>
